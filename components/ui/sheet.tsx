...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-[0_30px_120px_-40px_rgba(168,85,247,0.8),inset_0_0_0_1px_rgba(255,255,255,0.10)] transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 inline-flex h-9 w-9 items-center justify-center rounded-xl bg-white/5 text-muted-foreground shadow-[inset_0_0_0_1px_rgba(255,255,255,0.10)] transition hover:bg-white/10 hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/60">
        <X className="h-4 w-4" />
